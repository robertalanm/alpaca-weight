...
generation_output = model.generate(
    input_ids=input_ids, return_dict_in_generate=True, output_scores=True, max_new_tokens=256, do_sample=True, top_k=40, top_p=0.0, temperature=0.7, repetition_penalty = (1.0 / 0.85)
)
